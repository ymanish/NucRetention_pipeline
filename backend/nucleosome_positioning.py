...
class NPBackend:
  ...
  def Prob_Unwrapped(self, sequence, first_bound_site, last_bound_site):
    ...
    # print('Came out of the otup now')
    #print(otups)
    if (self.Ps[otups] == 0.0):
      prob = 0.25
    else:
  ...
  def ProbMono_Unwrapped(self, sequence, first_bound_site, last_bound_site):
  ...
  def PadSequence(self, seq, first_bound_site, last_bound_site):
    ...
    bp_start = NPBackend.bound_bp_left[first_bound_site-1]
    bp_end = NPBackend.bound_bp_right[last_bound_site-1]
    # print('Base start and base end ', bp_start, bp_end)
  ...
  def ProbLandscape_Unwrapped(self, longseq, first_bound_site, last_bound_site):
    ...
    # print(self.StrToSeq(longseq))
    # print('Padded sequence, ', padded_seq)
    # print(first_bound_site, last_bound_site)

    print(len(padded_seq))

    # The rest of the calculation continues as normal.
    N = len(padded_seq) - 146
    print('Extra nucleotides ', N)
    prob = np.zeros((N,))
    # print(prob)
    for i in range(N):
      if ( self.order > 1 ):
        print('..................................<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<')
        print(i, self.StrToSeq(padded_seq[i:i+147]))
