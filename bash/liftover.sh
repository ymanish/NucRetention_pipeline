...
if [ ! -f ../data/raw/hg19ToHg38.over.chain.gz ]; then
    ...
    wget http://hgdownload.soe.ucsc.edu/goldenPath/hg19/liftOver/hg19ToHg38.over.chain.gz -P ../data/annotations/
else
...
liftOver ../data/raw/authors_bed/GSM1346529_Human_146bp_peaks.bed ../data/annotations/hg19ToHg38.over.chain.gz ../data/raw/authors_bed_hg38/GSM1346529_peaks_hg38.bed ../data/raw/authors_bed_hg38/GSM1346529_unmapped.bed
